...
--
-- Host: localhost
-- Generation Time: Apr 11, 2022 at 02:25 PM
...
(37, 'wdw', 'General', '', 0, '', '', 0000, '0000-00-00 00:00:00', 'New');
...
(482, 52, '2014-03-20 23:38:00', '2014-01-03'),
...
(163, 15, 483, 'returned', '2014-02-21 00:30:00'),
...
--
ALTER TABLE `borrow`
  MODIFY `borrow_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=485;

--
-- AUTO_INCREMENT for table `borrowdetails`
--
ALTER TABLE `borrowdetails`
  MODIFY `borrow_details_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
...
--
ALTER TABLE `borrow`
  ADD CONSTRAINT `borrow_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`) ON UPDATE CASCADE;

--
-- Constraints for table `borrowdetails`
--
ALTER TABLE `borrowdetails`
  ADD CONSTRAINT `borrowdetails_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `borrowdetails_ibfk_2` FOREIGN KEY (`borrow_id`) REFERENCES `borrow` (`borrow_id`) ON UPDATE CASCADE;
COMMIT;
